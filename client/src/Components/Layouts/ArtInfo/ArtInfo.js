      ...
      <Grid container  className={classes.root} direction='column' >
          ...
          <div>
              <div className={classes.root} >
                    <img src={artUser[0].photo_url} alt={artUser[0].titel} className={classes.img} />
                </div>
                <div>
                    <Typography variant='h5' align='center' >
                    {artUser[0].titel}
                    </Typography>
                    <Typography variant='h6' align='center' >{artUser[0].name} (<StarRoundedIcon style={{color:yellow[400]}} /> {artUser[0].rate})</Typography>
                </div>
                <div className={classes.divs} style={{flexDirection:'column',justifyContent:'flex-end',marginTop:20}}>
